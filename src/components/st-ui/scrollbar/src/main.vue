...
export default {
  ...
  render (h) {
    ...
    if (gutter) {
      ...
      document.body.classList.add('chromeScrollShow')
    } else {
      document.body.classList.remove('chromeScrollShow')
    }
...
.chromeScrollShow ::-webkit-scrollbar {
